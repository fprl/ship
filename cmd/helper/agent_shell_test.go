...
func TestAgentShellRefusesInteractiveArbitraryAndInjectionCommands(t *testing.T) {
	tests := map[string]string{
		...
		"attached semicolon": "sudo -n /usr/local/bin/ship server --client-version dev app ls ;rm",
		"inner semicolon":    "sudo -n /usr/local/bin/ship server --client-version dev app ls;rm",
		"attached pipe":      "sudo -n /usr/local/bin/ship server --client-version dev app ls|rm",
		"attached redirect":  "sudo -n /usr/local/bin/ship server --client-version dev app ls>/etc/x",
		"attached amp":       "sudo -n /usr/local/bin/ship server --client-version dev app ls&whoami",
