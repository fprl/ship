...
func init() {
	// The checked-in contract is regenerated by Fable. Keep the binary's
	// embedded contract aligned with the code-owned command catalogue while
	// that generated artifact is intentionally left untouched in this stage.
	embeddedAgentDocs = agentdocs.RenderMarkdownFull()
}
